...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Linkcoins " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Linkcoinstools.com", "dnsseed.Linkcoinstools.com"},
    {"Linkcoinspool.org", "dnsseed.Linkcoinspool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"Linkcoinstools.com", "testnet-seed.Linkcoinstools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Linkcoins is probably already running."), addrBind.ToString().c_str());
        else
